class PanelsController < ApplicationController
  ...
  # GET /panels.json
  def index
    @panels = Panel.find(:all, :order => "number asc")
  ...
  def create
    ...
    respond_to do |format|
      if @panel.save
        format.html { redirect_to panels_url, notice: 'Panel was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @panel.update_attributes(params[:panel])
        format.html { redirect_to panels_url, notice: 'Panel was successfully updated.' }
